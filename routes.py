...
def add_calc_date_range():
    ...
    # So now every jinja template will have access to a date_range variable and that variable will contain the date_range function that we have defined here.
...
def index():
    ...
    # habits_on_date is a list of dictionaries where each dictionary has the data(keys) - id , name and added !!
